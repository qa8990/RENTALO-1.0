...
Library           DataDriver    file=RENTALO_MX.xlsx    sheet_name=GRUPO
...
*** Test Cases ***
Buscar - usando   ${categorylink}       ${categoryname}     ${groupname}        ${itemlink}
    

*** Keywords ***
Busqueda
    [Arguments]     ${categoryname}     ${categorylink}     ${groupname}       ${itemlink}
    LandingPage.Cargar Website
    LandingPage.Verificar Website cargado
    search_resources.Buscar Seccion Categorias      ${categorylink}
    search_resources.Buscar Grupo       ${categoryname}      ${groupname}       ${itemlink}
